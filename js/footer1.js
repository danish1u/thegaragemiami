...
<p>newsletter</p>
<form>
<div class="srchfooter"> <input type="text" class="srchfoo" placeholder="Enter your email address" />
<a href="http://my.ebay.com.au/ws/eBayISAPI.dll?AcceptSavedSeller&sellerid=thegaragemiami&refid=store&ssPageName=STORE:HTMLBUILDER:SIMPLEPAGE"> <button class="footer-btn" type="button">Submit</button> </a>
</div>
</form>
</div>
<div class="number"> <img src="https://raw.githubusercontent.com/danish1u/thegaragemiami/master/Images/number2.png" class="img-responsive" alt="" /></div>
<div class="socail_1">
<a href="https://www.facebook.com/tyreandmechanic/"> <i class="fa fa-facebook" aria-hidden="true"></i> </a><a href="https://www.instagram.com/thegaragegoldcoast/"><i class="fa fa-instagram" aria-hidden="true"></i> </a><a href="https://www.linkedin.com/company/18185838/"><i class="fa fa-linkedin" aria-hidden="true"></i></a></div>
</div>
</div>
...
<p>Copyright Â© 2017 thegaragemiami. All Rights Reserved.</p>
</div>
</div>
</div>
<div class="col-lg-6 col-md-6 col-sm-12">
<div class="row">
<div class="estorelogo"><span><a href="">Design By:</a></span>
<a href="https://www.upwork.com/o/profiles/users/_~015b640ac53e133434/"><img src="" alt="">M.Ali</a>
</div>
</div>
</div>
</div>
